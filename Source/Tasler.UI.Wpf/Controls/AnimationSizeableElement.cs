...
namespace Tasler.Windows.Controls
{
	...
	public partial class AnimationSizeableElement : FrameworkElement
	{
		...
		private Size cachedAvailableSize;
		...
		{
			get { return (FrameworkElement)base.GetValue(ChildProperty); }
		...
		protected override Size ArrangeOverride(Size arrangeSize)
		{
			...
			if (child != null)
			{
				...
				if (child.HorizontalAlignment == HorizontalAlignment.Stretch && !double.IsInfinity(this.cachedAvailableSize.Width))
					childSize.Width = this.cachedAvailableSize.Width;
				if (child.VerticalAlignment == VerticalAlignment.Stretch && !double.IsInfinity(this.cachedAvailableSize.Height))
					childSize.Height = this.cachedAvailableSize.Height;
