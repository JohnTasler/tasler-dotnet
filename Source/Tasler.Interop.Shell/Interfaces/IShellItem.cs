...
{
	/// <summary>
/// Binds the specified handler for this shell item and returns a pointer to the requested interface.
/// </summary>
/// <param name="pbc">Optional bind context supplied to the handler; may be null.</param>
