...
public static partial class PropertyKeys
{
	public static class PropGroup
	{
		...
		/// </list>
		/// </remarks>
		public static PropertyKey Advanced => new PropertyKey(0x900A403B, 0x097B, 0x4B95, 0x8A, 0xE2, 0x07, 0x1F, 0xDA, 0xEE, 0xB1, 0x18, 100);
		...
		/// </list>
		/// </remarks>
		public static PropertyKey Audio => new PropertyKey(0x2804D469, 0x788F, 0x48AA, 0x85, 0x70, 0x71, 0xB9, 0xC1, 0x87, 0xE1, 0x38, 100);
		...
		/// </list>
		/// </remarks>
		public static PropertyKey Calendar => new PropertyKey(0x9973D2B5, 0xBFD8, 0x438A, 0xBA, 0x94, 0x53, 0x49, 0xB2, 0x93, 0x18, 0x1A, 100);
		...
		/// </list>
		/// </remarks>
		public static PropertyKey Camera => new PropertyKey(0xDE00DE32, 0x547E, 0x4981, 0xAD, 0x4B, 0x54, 0x2F, 0x2E, 0x90, 0x07, 0xD8, 100);
		...
		/// </list>
		/// </remarks>
		public static PropertyKey Contact => new PropertyKey(0xDF975FD3, 0x250A, 0x4004, 0x85, 0x8F, 0x34, 0xE2, 0x9A, 0x3E, 0x37, 0xAA, 100);
		...
		/// </list>
		/// </remarks>
		public static PropertyKey Content => new PropertyKey(0xD0DAB0BA, 0x368A, 0x4050, 0xA8, 0x82, 0x6C, 0x01, 0x0F, 0xD1, 0x9A, 0x4F, 100);
		...
		/// </list>
		/// </remarks>
		public static PropertyKey Description => new PropertyKey(0x8969B275, 0x9475, 0x4E00, 0xA8, 0x87, 0xFF, 0x93, 0xB8, 0xB4, 0x1E, 0x44, 100);
		...
		/// </list>
		/// </remarks>
		public static PropertyKey FileSystem => new PropertyKey(0xE3A7D2C1, 0x80FC, 0x4B40, 0x8F, 0x34, 0x30, 0xEA, 0x11, 0x1B, 0xDC, 0x2E, 100);
		...
		/// </list>
		/// </remarks>
		public static PropertyKey General => new PropertyKey(0xCC301630, 0xB192, 0x4C22, 0xB3, 0x72, 0x9F, 0x4C, 0x6D, 0x33, 0x8E, 0x07, 100);
		...
		/// </list>
		/// </remarks>
		public static PropertyKey GPS => new PropertyKey(0xF3713ADA, 0x90E3, 0x4E11, 0xAA, 0xE5, 0xFD, 0xC1, 0x76, 0x85, 0xB9, 0xBE, 100);
		...
		/// </list>
		/// </remarks>
		public static PropertyKey Image => new PropertyKey(0xE3690A87, 0x0FA8, 0x4A2A, 0x9A, 0x9F, 0xFC, 0xE8, 0x82, 0x70, 0x55, 0xAC, 100);
		...
		/// </list>
		/// </remarks>
		public static PropertyKey Media => new PropertyKey(0x61872CF7, 0x6B5E, 0x4B4B, 0xAC, 0x2D, 0x59, 0xDA, 0x84, 0x45, 0x92, 0x48, 100);
		...
		/// </list>
		/// </remarks>
		public static PropertyKey MediaAdvanced => new PropertyKey(0x8859A284, 0xDE7E, 0x4642, 0x99, 0xBA, 0xD4, 0x31, 0xD0, 0x44, 0xB1, 0xEC, 100);
		...
		/// </list>
		/// </remarks>
		public static PropertyKey Message => new PropertyKey(0x7FD7259D, 0x16B4, 0x4135, 0x9F, 0x97, 0x7C, 0x96, 0xEC, 0xD2, 0xFA, 0x9E, 100);
		...
		/// </list>
		/// </remarks>
		public static PropertyKey Music => new PropertyKey(0x68DD6094, 0x7216, 0x40F1, 0xA0, 0x29, 0x43, 0xFE, 0x71, 0x27, 0x04, 0x3F, 100);
		...
		/// </list>
		/// </remarks>
		public static PropertyKey Origin => new PropertyKey(0x2598D2FB, 0x5569, 0x4367, 0x95, 0xDF, 0x5C, 0xD3, 0xA1, 0x77, 0xE1, 0xA5, 100);
		...
		/// </list>
		/// </remarks>
		public static PropertyKey PhotoAdvanced => new PropertyKey(0x0CB2BF5A, 0x9EE7, 0x4A86, 0x82, 0x22, 0xF0, 0x1E, 0x07, 0xFD, 0xAD, 0xAF, 100);
		...
		/// </list>
		/// </remarks>
		public static PropertyKey RecordedTV => new PropertyKey(0xE7B33238, 0x6584, 0x4170, 0xA5, 0xC0, 0xAC, 0x25, 0xEF, 0xD9, 0xDA, 0x56, 100);
		...
		/// </list>
		/// </remarks>
		public static PropertyKey Video => new PropertyKey(0xBEBE0920, 0x7671, 0x4C54, 0xA3, 0xEB, 0x49, 0xFD, 0xDF, 0xC1, 0x91, 0xEE, 100);
	}
}
