...
public static partial class PropertyKeys
{
	public static class Calendar
	{
		...
		/// </list>
		/// </remarks>
		public static PropertyKey Duration => new PropertyKey(0x293CA35A, 0x09AA, 0x4DD2, 0xB1, 0x80, 0x1F, 0xE2, 0x45, 0x72, 0x8A, 0x52, 100);
		...
		/// </list>
		/// </remarks>
		public static PropertyKey IsOnline => new PropertyKey(0xBFEE9149, 0xE3E2, 0x49A7, 0xA8, 0x62, 0xC0, 0x59, 0x88, 0x14, 0x5C, 0xEC, 100);
		...
		/// </list>
		/// </remarks>
		public static PropertyKey IsRecurring => new PropertyKey(0x315B9C8D, 0x80A9, 0x4EF9, 0xAE, 0x16, 0x8E, 0x74, 0x6D, 0xA5, 0x1D, 0x70, 100);
		...
		/// </list>
		/// </remarks>
		public static PropertyKey Location => new PropertyKey(0xF6272D18, 0xCECC, 0x40B1, 0xB2, 0x6A, 0x39, 0x11, 0x71, 0x7A, 0xA7, 0xBD, 100);
		...
		/// </list>
		/// </remarks>
		public static PropertyKey OptionalAttendeeAddresses => new PropertyKey(0xD55BAE5A, 0x3892, 0x417A, 0xA6, 0x49, 0xC6, 0xAC, 0x5A, 0xAA, 0xEA, 0xB3, 100);
		...
		/// </list>
		/// </remarks>
		public static PropertyKey OptionalAttendeeNames => new PropertyKey(0x09429607, 0x582D, 0x437F, 0x84, 0xC3, 0xDE, 0x93, 0xA2, 0xB2, 0x4C, 0x3C, 100);
		...
		/// </list>
		/// </remarks>
		public static PropertyKey OrganizerAddress => new PropertyKey(0x744C8242, 0x4DF5, 0x456C, 0xAB, 0x9E, 0x01, 0x4E, 0xFB, 0x90, 0x21, 0xE3, 100);
		...
		/// </list>
		/// </remarks>
		public static PropertyKey OrganizerName => new PropertyKey(0xAAA660F9, 0x9865, 0x458E, 0xB4, 0x84, 0x01, 0xBC, 0x7F, 0xE3, 0x97, 0x3E, 100);
		...
		/// </list>
		/// </remarks>
		public static PropertyKey ReminderTime => new PropertyKey(0x72FC5BA4, 0x24F9, 0x4011, 0x9F, 0x3F, 0xAD, 0xD2, 0x7A, 0xFA, 0xD8, 0x18, 100);
		...
		/// </list>
		/// </remarks>
		public static PropertyKey RequiredAttendeeAddresses => new PropertyKey(0x0BA7D6C3, 0x568D, 0x4159, 0xAB, 0x91, 0x78, 0x1A, 0x91, 0xFB, 0x71, 0xE5, 100);
		...
		/// </list>
		/// </remarks>
		public static PropertyKey RequiredAttendeeNames => new PropertyKey(0xB33AF30B, 0xF552, 0x4584, 0x93, 0x6C, 0xCB, 0x93, 0xE5, 0xCD, 0xA2, 0x9F, 100);
		...
		/// </list>
		/// </remarks>
		public static PropertyKey Resources => new PropertyKey(0x00F58A38, 0xC54B, 0x4C40, 0x86, 0x96, 0x97, 0x23, 0x59, 0x80, 0xEA, 0xE1, 100);
		...
		/// </list>
		/// </remarks>
		public static PropertyKey ShowTimeAs => new PropertyKey(0x5BF396D4, 0x5EB2, 0x466F, 0xBD, 0xE9, 0x2F, 0xB3, 0xF2, 0x36, 0x1D, 0x6E, 100);
		...
		/// </list>
		/// </remarks>
		public static PropertyKey ShowTimeAsText => new PropertyKey(0x53DA57CF, 0x62C0, 0x45C4, 0x81, 0xDE, 0x76, 0x10, 0xBC, 0xEF, 0xD7, 0xF5, 100);
	}
}