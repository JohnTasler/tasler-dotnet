...
public static partial class PropertyKeys
{
	public static class Image
	{
		...
		/// <remarks>
		/// <list type="table">
		///   <item><term><b>Name:     </b></term><description>System.Image.BitDepth -- PKEY_Image_BitDepth</description></item>
		...
		/// <remarks>
		/// <list type="table">
		///   <item><term><b>Name:     </b></term><description>System.Image.ColorSpace -- PKEY_Image_ColorSpace</description></item>
		...
		/// <summary>Possible discrete values for PKEY_Image_ColorSpace.</summary>
		...
		/// <summary>
		/// Calculated from PKEY_Image_CompressedBitsPerPixelNumerator and PKEY_Image_CompressedBitsPerPixelDenominator.</summary>
		/// <remarks>
		/// <list type="table">
		///   <item><term><b>Name:     </b></term><description>System.Image.CompressedBitsPerPixel -- PKEY_Image_CompressedBitsPerPixel</description></item>
		...
		/// <summary>
		/// Denominator of PKEY_Image_CompressedBitsPerPixel.</summary>
		/// <remarks>
		/// <list type="table">
		///   <item><term><b>Name:     </b></term><description>System.Image.CompressedBitsPerPixelDenominator -- PKEY_Image_CompressedBitsPerPixelDenominator</description></item>
		///   <item><term><b>Type:     </b></term><description>UInt32 -- VT_UI4</description></item>
		...
		/// <summary>
		/// Numerator of PKEY_Image_CompressedBitsPerPixel.</summary>
		/// <remarks>
		/// <list type="table">
		///   <item><term><b>Name:     </b></term><description>System.Image.CompressedBitsPerPixelNumerator -- PKEY_Image_CompressedBitsPerPixelNumerator</description></item>
		///   <item><term><b>Type:     </b></term><description>UInt32 -- VT_UI4</description></item>
		...
		/// <remarks>
		/// <list type="table">
		///   <item><term><b>Name:     </b></term><description>System.Image.Compression -- PKEY_Image_Compression</description></item>
		///   <item><term><b>Type:     </b></term><description>UInt16 -- VT_UI2</description></item>
		...
		/// <summary>Possible discrete values for PKEY_Image_Compression.</summary>
		public enum CompressionLevel : short
		{
			...
			Lzw = 5,
			Jpeg = 6,
			Packbits = unchecked((short)32773),
		}
		...
		/// <remarks>
		/// <list type="table">
		///   <item><term><b>Name:     </b></term><description>System.Image.CompressionText -- PKEY_Image_CompressionText</description></item>
		...
		/// <remarks>
		/// <list type="table">
		///   <item><term><b>Name:     </b></term><description>System.Image.Dimensions -- PKEY_Image_Dimensions</description></item>
		///   <item><term><b>Type:     </b></term><description>String -- VT_LPWSTR  (For variants: VT_BSTR)</description></item>
		...
		/// <remarks>
		/// <list type="table">
		///   <item><term><b>Name:     </b></term><description>System.Image.HorizontalResolution -- PKEY_Image_HorizontalResolution</description></item>
		///   <item><term><b>Type:     </b></term><description>Double -- VT_R8</description></item>
		...
		/// <remarks>
		/// <list type="table">
		///   <item><term><b>Name:     </b></term><description>System.Image.HorizontalSize -- PKEY_Image_HorizontalSize</description></item>
		///   <item><term><b>Type:     </b></term><description>UInt32 -- VT_UI4</description></item>
		...
		/// <remarks>
		/// <list type="table">
		///   <item><term><b>Name:     </b></term><description>System.Image.ImageID -- PKEY_Image_ImageID</description></item>
		///   <item><term><b>Type:     </b></term><description>String -- VT_LPWSTR  (For variants: VT_BSTR)</description></item>
		...
		/// <remarks>
		/// <list type="table">
		///   <item><term><b>Name:     </b></term><description>System.Image.ResolutionUnit -- PKEY_Image_ResolutionUnit</description></item>
		...
		/// <remarks>
		/// <list type="table">
		///   <item><term><b>Name:     </b></term><description>System.Image.VerticalResolution -- PKEY_Image_VerticalResolution</description></item>
		///   <item><term><b>Type:     </b></term><description>Double -- VT_R8</description></item>
		...
		/// <remarks>
		/// <list type="table">
		///   <item><term><b>Name:     </b></term><description>System.Image.VerticalSize -- PKEY_Image_VerticalSize</description></item>
		///   <item><term><b>Type:     </b></term><description>UInt32 -- VT_UI4</description></item>
