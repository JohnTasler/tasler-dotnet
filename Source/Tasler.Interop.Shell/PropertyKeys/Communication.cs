...
namespace Tasler.Interop.Shell
{
	public static partial class PropertyKeys
	{
		public static class Communication
		{
			...
			/// </list>
			/// </remarks>
			public static PropertyKey AccountName { get { return new PropertyKey(0xE3E0584C, 0xB788, 0x4A5A, 0xBB, 0x20, 0x7F, 0x5A, 0x44, 0xC9, 0xAC, 0xDD, 9); } }
			...
			/// </list>
			/// </remarks>
			public static PropertyKey Suffix { get { return new PropertyKey(0x807B653A, 0x9E91, 0x43EF, 0x8F, 0x97, 0x11, 0xCE, 0x04, 0xEE, 0x20, 0xC5, 100); } }
			...
			/// </list>
			/// </remarks>
			public static PropertyKey TaskStatus { get { return new PropertyKey(0xBE1A72C6, 0x9A1D, 0x46B7, 0xAF, 0xE7, 0xAF, 0xAF, 0x8C, 0xEF, 0x49, 0x99, 100); } }
			...
			/// </list>
			/// </remarks>
			public static PropertyKey TaskStatusText { get { return new PropertyKey(0xA6744477, 0xC237, 0x475B, 0xA0, 0x75, 0x54, 0xF3, 0x44, 0x98, 0x29, 0x2A, 100); } }
		}
	}
}