...
namespace Tasler.Interop.Shell
{
	public static partial class PropertyKeys
	{
		public static class Volume
		{
			...
			/// </list>
			/// </remarks>
			public static PropertyKey FileSystem { get { return new PropertyKey(0x9B174B35, 0x40FF, 0x11D2, 0xA2, 0x7E, 0x00, 0xC0, 0x4F, 0xC3, 0x08, 0x71, 4); } }
			...
			/// </list>
			/// </remarks>
			public static PropertyKey IsMappedDrive { get { return new PropertyKey(0x149C0B69, 0x2C2D, 0x48FC, 0x80, 0x8F, 0xD3, 0x18, 0xD7, 0x8C, 0x46, 0x36, 2); } }
			...
			/// </list>
			/// </remarks>
			public static PropertyKey IsRoot { get { return new PropertyKey(0x9B174B35, 0x40FF, 0x11D2, 0xA2, 0x7E, 0x00, 0xC0, 0x4F, 0xC3, 0x08, 0x71, 10); } }
		}
	}
}