...
public static partial class PropertyKeys
{
	public static class Audio
	{
		...
		/// </list>
		/// </remarks>
		public static PropertyKey ChannelCount => new PropertyKey(0x64440490, 0x4C8B, 0x11D1, 0x8B, 0x70, 0x08, 0x00, 0x36, 0xB1, 0x1A, 0x03, 7);
		...
		/// </list>
		/// </remarks>
		public static PropertyKey Compression => new PropertyKey(0x64440490, 0x4C8B, 0x11D1, 0x8B, 0x70, 0x08, 0x00, 0x36, 0xB1, 0x1A, 0x03, 10);
		...
		/// </list>
		/// </remarks>
		public static PropertyKey EncodingBitrate => new PropertyKey(0x64440490, 0x4C8B, 0x11D1, 0x8B, 0x70, 0x08, 0x00, 0x36, 0xB1, 0x1A, 0x03, 4);
		...
		/// </list>
		/// </remarks>
		public static PropertyKey Format => new PropertyKey(0x64440490, 0x4C8B, 0x11D1, 0x8B, 0x70, 0x08, 0x00, 0x36, 0xB1, 0x1A, 0x03, 2);
		...
		/// </list>
		/// </remarks>
		public static PropertyKey IsVariableBitRate => new PropertyKey(0xE6822FEE, 0x8C17, 0x4D62, 0x82, 0x3C, 0x8E, 0x9C, 0xFC, 0xBD, 0x1D, 0x5C, 100);
		...
		/// </list>
		/// </remarks>
		public static PropertyKey PeakValue => new PropertyKey(0x2579E5D0, 0x1116, 0x4084, 0xBD, 0x9A, 0x9B, 0x4F, 0x7C, 0xB4, 0xDF, 0x5E, 100);
		...
		/// </list>
		/// </remarks>
		public static PropertyKey SampleRate => new PropertyKey(0x64440490, 0x4C8B, 0x11D1, 0x8B, 0x70, 0x08, 0x00, 0x36, 0xB1, 0x1A, 0x03, 5);
		...
		/// </list>
		/// </remarks>
		public static PropertyKey SampleSize => new PropertyKey(0x64440490, 0x4C8B, 0x11D1, 0x8B, 0x70, 0x08, 0x00, 0x36, 0xB1, 0x1A, 0x03, 6);
		...
		/// </list>
		/// </remarks>
		public static PropertyKey StreamName => new PropertyKey(0x64440490, 0x4C8B, 0x11D1, 0x8B, 0x70, 0x08, 0x00, 0x36, 0xB1, 0x1A, 0x03, 9);
		...
		/// </list>
		/// </remarks>
		public static PropertyKey StreamNumber => new PropertyKey(0x64440490, 0x4C8B, 0x11D1, 0x8B, 0x70, 0x08, 0x00, 0x36, 0xB1, 0x1A, 0x03, 8);
	}
}