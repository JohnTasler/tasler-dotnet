...
public static partial class PropertyKeys
{
	public static class Audio
	{
		...
		/// <remarks>
		/// <list type="table">
		///   <item><term><b>Name:     </b></term><description>System.Audio.ChannelCount -- PKEY_Audio_ChannelCount</description></item>
		...
		/// </list>
		/// </remarks>
		public static PropertyKey ChannelCount => new(0x64440490, 0x4C8B, 0x11D1, 0x8B, 0x70, 0x08, 0x00, 0x36, 0xB1, 0x1A, 0x03, 7);

		/// <summary>
		/// </summary>
		/// <remarks>
		/// <list type="table">
		///   <item><term><b>Name:     </b></term><description>System.Audio.Compression -- PKEY_Audio_Compression</description></item>
		...
		/// </list>
		/// </remarks>
		public static PropertyKey Compression => new(0x64440490, 0x4C8B, 0x11D1, 0x8B, 0x70, 0x08, 0x00, 0x36, 0xB1, 0x1A, 0x03, 10);

		/// <summary>
		/// Indicates the average data rate in Hz for the audio file in "bits per second".</summary>
		/// <remarks>
		/// <list type="table">
		///   <item><term><b>Name:     </b></term><description>System.Audio.EncodingBitrate -- PKEY_Audio_EncodingBitrate</description></item>
		///   <item><term><b>Type:     </b></term><description>UInt32 -- VT_UI4</description></item>
		...
		/// </list>
		/// </remarks>
		public static PropertyKey EncodingBitrate => new(0x64440490, 0x4C8B, 0x11D1, 0x8B, 0x70, 0x08, 0x00, 0x36, 0xB1, 0x1A, 0x03, 4);

		/// <summary>
		/// Indicates the format of the audio file.</summary>
		/// <remarks>
		/// <list type="table">
		///   <item><term><b>Name:     </b></term><description>System.Audio.Format -- PKEY_Audio_Format</description></item>
		...
		/// </list>
		/// </remarks>
		public static PropertyKey Format => new(0x64440490, 0x4C8B, 0x11D1, 0x8B, 0x70, 0x08, 0x00, 0x36, 0xB1, 0x1A, 0x03, 2);

		/// <summary></summary>
		/// <remarks>
		/// <list type="table">
		///   <item><term><b>Name:     </b></term><description>System.Audio.IsVariableBitRate -- PKEY_Audio_IsVariableBitRate</description></item>
		...
		/// </list>
		/// </remarks>
		public static PropertyKey IsVariableBitRate => new(0xE6822FEE, 0x8C17, 0x4D62, 0x82, 0x3C, 0x8E, 0x9C, 0xFC, 0xBD, 0x1D, 0x5C, 100);

		/// <summary></summary>
		/// <remarks>
		/// <list type="table">
		///   <item><term><b>Name:     </b></term><description>System.Audio.PeakValue -- PKEY_Audio_PeakValue</description></item>
		///   <item><term><b>Type:     </b></term><description>UInt32 -- VT_UI4</description></item>
		///   <item><term><b>Format ID:</b></term><description>2579E5D0-1116-4084-BD9A-9B4F7CB4DF5E, 100</description></item>
		/// </list>
		/// </remarks>
		public static PropertyKey PeakValue => new(0x2579E5D0, 0x1116, 0x4084, 0xBD, 0x9A, 0x9B, 0x4F, 0x7C, 0xB4, 0xDF, 0x5E, 100);

		/// <summary>
		/// Indicates the audio sample rate for the audio file in "samples per second".</summary>
		/// <remarks>
		/// <list type="table">
		///   <item><term><b>Name:     </b></term><description>System.Audio.SampleRate -- PKEY_Audio_SampleRate</description></item>
		///   <item><term><b>Type:     </b></term><description>UInt32 -- VT_UI4</description></item>
		...
		/// </list>
		/// </remarks>
		public static PropertyKey SampleRate => new(0x64440490, 0x4C8B, 0x11D1, 0x8B, 0x70, 0x08, 0x00, 0x36, 0xB1, 0x1A, 0x03, 5);

		/// <summary>
		/// Indicates the audio sample size for the audio file in "bits per sample".</summary>
		/// <remarks>
		/// <list type="table">
		///   <item><term><b>Name:     </b></term><description>System.Audio.SampleSize -- PKEY_Audio_SampleSize</description></item>
		///   <item><term><b>Type:     </b></term><description>UInt32 -- VT_UI4</description></item>
		...
		/// </list>
		/// </remarks>
		public static PropertyKey SampleSize => new(0x64440490, 0x4C8B, 0x11D1, 0x8B, 0x70, 0x08, 0x00, 0x36, 0xB1, 0x1A, 0x03, 6);

		/// <summary>
		/// </summary>
		/// <remarks>
		/// <list type="table">
		///   <item><term><b>Name:     </b></term><description>System.Audio.StreamName:        -- PKEY_Audio_StreamName:       </description></item>
		///   <item><term><b>Type:     </b></term><description>String -- VT_LPWSTR  (For variants: VT_BSTR)</description></item>
		...
		/// </list>
		/// </remarks>
		public static PropertyKey StreamName => new(0x64440490, 0x4C8B, 0x11D1, 0x8B, 0x70, 0x08, 0x00, 0x36, 0xB1, 0x1A, 0x03, 9);

		/// <summary>
		/// </summary>
		/// <remarks>
		/// <list type="table">
		///   <item><term><b>Name:     </b></term><description>System.Audio.StreamNumber -- PKEY_Audio_StreamNumber</description></item>
		...
		/// </list>
		/// </remarks>
		public static PropertyKey StreamNumber => new(0x64440490, 0x4C8B, 0x11D1, 0x8B, 0x70, 0x08, 0x00, 0x36, 0xB1, 0x1A, 0x03, 8);
	}
}
