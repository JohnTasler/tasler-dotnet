...
public static partial class PropertyKeys
{
	public static class Task
	{
		...
		/// </list>
		/// </remarks>
		public static PropertyKey BillingInformation => new(0xD37D52C6, 0x261C, 0x4303, 0x82, 0xB3, 0x08, 0xB9, 0x26, 0xAC, 0x6F, 0x12, 100);
		...
		/// </list>
		/// </remarks>
		public static PropertyKey CompletionStatus => new(0x084D8A0A, 0xE6D5, 0x40DE, 0xBF, 0x1F, 0xC8, 0x82, 0x0E, 0x7C, 0x87, 0x7C, 100);
		...
		/// </list>
		/// </remarks>
		public static PropertyKey Owner => new(0x08C7CC5F, 0x60F2, 0x4494, 0xAD, 0x75, 0x55, 0xE3, 0xE0, 0xB5, 0xAD, 0xD0, 100);
	}
}
