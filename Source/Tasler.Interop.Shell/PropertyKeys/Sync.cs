...
namespace Tasler.Interop.Shell
{
	public static partial class PropertyKeys
	{
		public static class Sync
		{
			...
			/// </list>
			/// </remarks>
			public static PropertyKey Comments { get { return new PropertyKey(0x7BD5533E, 0xAF15, 0x44DB, 0xB8, 0xC8, 0xBD, 0x66, 0x24, 0xE1, 0xD0, 0x32, 13); } }
			...
			/// </list>
			/// </remarks>
			public static PropertyKey ConflictDescription { get { return new PropertyKey(0xCE50C159, 0x2FB8, 0x41FD, 0xBE, 0x68, 0xD3, 0xE0, 0x42, 0xE2, 0x74, 0xBC, 4); } }
			...
			/// </list>
			/// </remarks>
			public static PropertyKey ConflictFirstLocation { get { return new PropertyKey(0xCE50C159, 0x2FB8, 0x41FD, 0xBE, 0x68, 0xD3, 0xE0, 0x42, 0xE2, 0x74, 0xBC, 6); } }
			...
			/// </list>
			/// </remarks>
			public static PropertyKey ConflictSecondLocation { get { return new PropertyKey(0xCE50C159, 0x2FB8, 0x41FD, 0xBE, 0x68, 0xD3, 0xE0, 0x42, 0xE2, 0x74, 0xBC, 7); } }
			...
			/// </list>
			/// </remarks>
			public static PropertyKey HandlerCollectionID { get { return new PropertyKey(0x7BD5533E, 0xAF15, 0x44DB, 0xB8, 0xC8, 0xBD, 0x66, 0x24, 0xE1, 0xD0, 0x32, 2); } }
			...
			/// </list>
			/// </remarks>
			public static PropertyKey HandlerID { get { return new PropertyKey(0x7BD5533E, 0xAF15, 0x44DB, 0xB8, 0xC8, 0xBD, 0x66, 0x24, 0xE1, 0xD0, 0x32, 3); } }
			...
			/// </list>
			/// </remarks>
			public static PropertyKey HandlerName { get { return new PropertyKey(0xCE50C159, 0x2FB8, 0x41FD, 0xBE, 0x68, 0xD3, 0xE0, 0x42, 0xE2, 0x74, 0xBC, 2); } }
			...
			/// </list>
			/// </remarks>
			public static PropertyKey HandlerType { get { return new PropertyKey(0x7BD5533E, 0xAF15, 0x44DB, 0xB8, 0xC8, 0xBD, 0x66, 0x24, 0xE1, 0xD0, 0x32, 8); } }
			...
			/// </list>
			/// </remarks>
			public static PropertyKey HandlerTypeLabel { get { return new PropertyKey(0x7BD5533E, 0xAF15, 0x44DB, 0xB8, 0xC8, 0xBD, 0x66, 0x24, 0xE1, 0xD0, 0x32, 9); } }
			...
			/// </list>
			/// </remarks>
			public static PropertyKey ItemID { get { return new PropertyKey(0x7BD5533E, 0xAF15, 0x44DB, 0xB8, 0xC8, 0xBD, 0x66, 0x24, 0xE1, 0xD0, 0x32, 6); } }
			...
			/// </list>
			/// </remarks>
			public static PropertyKey ItemName { get { return new PropertyKey(0xCE50C159, 0x2FB8, 0x41FD, 0xBE, 0x68, 0xD3, 0xE0, 0x42, 0xE2, 0x74, 0xBC, 3); } }
		}
	}
}