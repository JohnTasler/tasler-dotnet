...
namespace Tasler.Interop.Shell
{
	public static partial class PropertyKeys
	{
		public static class Search
		{
			...
			/// </list>
			/// </remarks>
			public static PropertyKey AutoSummary { get { return new PropertyKey(0x560C36C0, 0x503A, 0x11CF, 0xBA, 0xA1, 0x00, 0x00, 0x4C, 0x75, 0x2A, 0x9A, 2); } }
			...
			/// </list>
			/// </remarks>
			public static PropertyKey ContainerHash { get { return new PropertyKey(0xBCEEE283, 0x35DF, 0x4D53, 0x82, 0x6A, 0xF3, 0x6A, 0x3E, 0xEF, 0xC6, 0xBE, 100); } }
			...
			/// </list>
			/// </remarks>
			public static PropertyKey Contents { get { return new PropertyKey(0xB725F130, 0x47EF, 0x101A, 0xA5, 0xF1, 0x02, 0x60, 0x8C, 0x9E, 0xEB, 0xAC, 19); } }
			...
			/// </list>
			/// </remarks>
			public static PropertyKey EntryID { get { return new PropertyKey(0x49691C90, 0x7E17, 0x101A, 0xA9, 0x1C, 0x08, 0x00, 0x2B, 0x2E, 0xCD, 0xA9, 5); } }
			...
			/// </list>
			/// </remarks>
			public static PropertyKey GatherTime { get { return new PropertyKey(0x0B63E350, 0x9CCC, 0x11D0, 0xBC, 0xDB, 0x00, 0x80, 0x5F, 0xCC, 0xCE, 0x04, 8); } }
			...
			/// </list>
			/// </remarks>
			public static PropertyKey IsClosedDirectory { get { return new PropertyKey(0x0B63E343, 0x9CCC, 0x11D0, 0xBC, 0xDB, 0x00, 0x80, 0x5F, 0xCC, 0xCE, 0x04, 23); } }
			...
			/// </list>
			/// </remarks>
			public static PropertyKey IsFullyContained { get { return new PropertyKey(0x0B63E343, 0x9CCC, 0x11D0, 0xBC, 0xDB, 0x00, 0x80, 0x5F, 0xCC, 0xCE, 0x04, 24); } }
			...
			/// </list>
			/// </remarks>
			public static PropertyKey QueryFocusedSummary { get { return new PropertyKey(0x560C36C0, 0x503A, 0x11CF, 0xBA, 0xA1, 0x00, 0x00, 0x4C, 0x75, 0x2A, 0x9A, 3); } }
			...
			/// </list>
			/// </remarks>
			public static PropertyKey Rank { get { return new PropertyKey(0x49691C90, 0x7E17, 0x101A, 0xA9, 0x1C, 0x08, 0x00, 0x2B, 0x2E, 0xCD, 0xA9, 3); } }
			...
			/// </list>
			/// </remarks>
			public static PropertyKey Store { get { return new PropertyKey(0xA06992B3, 0x8CAF, 0x4ED7, 0xA5, 0x47, 0xB2, 0x59, 0xE3, 0x2A, 0xC9, 0xFC, 100); } }
			...
			/// </list>
			/// </remarks>
			public static PropertyKey UrlToIndex { get { return new PropertyKey(0x0B63E343, 0x9CCC, 0x11D0, 0xBC, 0xDB, 0x00, 0x80, 0x5F, 0xCC, 0xCE, 0x04, 2); } }
			...
			/// </list>
			/// </remarks>
			public static PropertyKey UrlToIndexWithModificationTime { get { return new PropertyKey(0x0B63E343, 0x9CCC, 0x11D0, 0xBC, 0xDB, 0x00, 0x80, 0x5F, 0xCC, 0xCE, 0x04, 12); } }
		}
	}
}