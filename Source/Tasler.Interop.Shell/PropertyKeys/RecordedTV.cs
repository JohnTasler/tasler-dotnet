...
public static partial class PropertyKeys
{
	public static class RecordedTV
	{
		...
		/// </list>
		/// </remarks>
		public static PropertyKey ChannelNumber => new PropertyKey(0x6D748DE2, 0x8D38, 0x4CC3, 0xAC, 0x60, 0xF0, 0x09, 0xB0, 0x57, 0xC5, 0x57, 7);
		...
		/// </list>
		/// </remarks>
		public static PropertyKey Credits => new PropertyKey(0x6D748DE2, 0x8D38, 0x4CC3, 0xAC, 0x60, 0xF0, 0x09, 0xB0, 0x57, 0xC5, 0x57, 4);
		...
		/// </list>
		/// </remarks>
		public static PropertyKey DateContentExpires => new PropertyKey(0x6D748DE2, 0x8D38, 0x4CC3, 0xAC, 0x60, 0xF0, 0x09, 0xB0, 0x57, 0xC5, 0x57, 15);
		...
		/// </list>
		/// </remarks>
		public static PropertyKey EpisodeName => new PropertyKey(0x6D748DE2, 0x8D38, 0x4CC3, 0xAC, 0x60, 0xF0, 0x09, 0xB0, 0x57, 0xC5, 0x57, 2);
		...
		/// </list>
		/// </remarks>
		public static PropertyKey IsATSCContent => new PropertyKey(0x6D748DE2, 0x8D38, 0x4CC3, 0xAC, 0x60, 0xF0, 0x09, 0xB0, 0x57, 0xC5, 0x57, 16);
		...
		/// </list>
		/// </remarks>
		public static PropertyKey IsClosedCaptioningAvailable => new PropertyKey(0x6D748DE2, 0x8D38, 0x4CC3, 0xAC, 0x60, 0xF0, 0x09, 0xB0, 0x57, 0xC5, 0x57, 12);
		...
		/// </list>
		/// </remarks>
		public static PropertyKey IsDTVContent => new PropertyKey(0x6D748DE2, 0x8D38, 0x4CC3, 0xAC, 0x60, 0xF0, 0x09, 0xB0, 0x57, 0xC5, 0x57, 17);
		...
		/// </list>
		/// </remarks>
		public static PropertyKey IsHDContent => new PropertyKey(0x6D748DE2, 0x8D38, 0x4CC3, 0xAC, 0x60, 0xF0, 0x09, 0xB0, 0x57, 0xC5, 0x57, 18);
		...
		/// </list>
		/// </remarks>
		public static PropertyKey IsRepeatBroadcast => new PropertyKey(0x6D748DE2, 0x8D38, 0x4CC3, 0xAC, 0x60, 0xF0, 0x09, 0xB0, 0x57, 0xC5, 0x57, 13);
		...
		/// </list>
		/// </remarks>
		public static PropertyKey IsSAP => new PropertyKey(0x6D748DE2, 0x8D38, 0x4CC3, 0xAC, 0x60, 0xF0, 0x09, 0xB0, 0x57, 0xC5, 0x57, 14);
		...
		/// </list>
		/// </remarks>
		public static PropertyKey NetworkAffiliation => new PropertyKey(0x2C53C813, 0xFB63, 0x4E22, 0xA1, 0xAB, 0x0B, 0x33, 0x1C, 0xA1, 0xE2, 0x73, 100);
		...
		/// </list>
		/// </remarks>
		public static PropertyKey OriginalBroadcastDate => new PropertyKey(0x4684FE97, 0x8765, 0x4842, 0x9C, 0x13, 0xF0, 0x06, 0x44, 0x7B, 0x17, 0x8C, 100);
		...
		/// </list>
		/// </remarks>
		public static PropertyKey ProgramDescription => new PropertyKey(0x6D748DE2, 0x8D38, 0x4CC3, 0xAC, 0x60, 0xF0, 0x09, 0xB0, 0x57, 0xC5, 0x57, 3);
		...
		/// </list>
		/// </remarks>
		public static PropertyKey RecordingTime => new PropertyKey(0xA5477F61, 0x7A82, 0x4ECA, 0x9D, 0xDE, 0x98, 0xB6, 0x9B, 0x24, 0x79, 0xB3, 100);
		...
		/// </list>
		/// </remarks>
		public static PropertyKey StationCallSign => new PropertyKey(0x6D748DE2, 0x8D38, 0x4CC3, 0xAC, 0x60, 0xF0, 0x09, 0xB0, 0x57, 0xC5, 0x57, 5);
		...
		/// </list>
		/// </remarks>
		public static PropertyKey StationName => new PropertyKey(0x1B5439E7, 0xEBA1, 0x4AF8, 0xBD, 0xD7, 0x7A, 0xF1, 0xD4, 0x54, 0x94, 0x93, 100);
	}
}
