...
public static partial class PropertyKeys
{
	public static class GPS
	{
		...
		/// </list>
		/// </remarks>
		public static PropertyKey Altitude => new PropertyKey(0x827EDB4F, 0x5B73, 0x44A7, 0x89, 0x1D, 0xFD, 0xFF, 0xAB, 0xEA, 0x35, 0xCA, 100);
		...
		/// </list>
		/// </remarks>
		public static PropertyKey AltitudeDenominator => new PropertyKey(0x78342DCB, 0xE358, 0x4145, 0xAE, 0x9A, 0x6B, 0xFE, 0x4E, 0x0F, 0x9F, 0x51, 100);
		...
		/// </list>
		/// </remarks>
		public static PropertyKey AltitudeNumerator => new PropertyKey(0x2DAD1EB7, 0x816D, 0x40D3, 0x9E, 0xC3, 0xC9, 0x77, 0x3B, 0xE2, 0xAA, 0xDE, 100);
		...
		/// </list>
		/// </remarks>
		public static PropertyKey AltitudeRef => new PropertyKey(0x46AC629D, 0x75EA, 0x4515, 0x86, 0x7F, 0x6D, 0xC4, 0x32, 0x1C, 0x58, 0x44, 100);
		...
		/// </list>
		/// </remarks>
		public static PropertyKey AreaInformation => new PropertyKey(0x972E333E, 0xAC7E, 0x49F1, 0x8A, 0xDF, 0xA7, 0x0D, 0x07, 0xA9, 0xBC, 0xAB, 100);
		...
		/// </list>
		/// </remarks>
		public static PropertyKey Date => new PropertyKey(0x3602C812, 0x0F3B, 0x45F0, 0x85, 0xAD, 0x60, 0x34, 0x68, 0xD6, 0x94, 0x23, 100);
		...
		/// </list>
		/// </remarks>
		public static PropertyKey DestBearing => new PropertyKey(0xC66D4B3C, 0xE888, 0x47CC, 0xB9, 0x9F, 0x9D, 0xCA, 0x3E, 0xE3, 0x4D, 0xEA, 100);
		...
		/// </list>
		/// </remarks>
		public static PropertyKey DestBearingDenominator => new PropertyKey(0x7ABCF4F8, 0x7C3F, 0x4988, 0xAC, 0x91, 0x8D, 0x2C, 0x2E, 0x97, 0xEC, 0xA5, 100);
		...
		/// </list>
		/// </remarks>
		public static PropertyKey DestBearingNumerator => new PropertyKey(0xBA3B1DA9, 0x86EE, 0x4B5D, 0xA2, 0xA4, 0xA2, 0x71, 0xA4, 0x29, 0xF0, 0xCF, 100);
		...
		/// </list>
		/// </remarks>
		public static PropertyKey DestBearingRef => new PropertyKey(0x9AB84393, 0x2A0F, 0x4B75, 0xBB, 0x22, 0x72, 0x79, 0x78, 0x69, 0x77, 0xCB, 100);
		...
		/// </list>
		/// </remarks>
		public static PropertyKey DestDistance => new PropertyKey(0xA93EAE04, 0x6804, 0x4F24, 0xAC, 0x81, 0x09, 0xB2, 0x66, 0x45, 0x21, 0x18, 100);
		...
		/// </list>
		/// </remarks>
		public static PropertyKey DestDistanceDenominator => new PropertyKey(0x9BC2C99B, 0xAC71, 0x4127, 0x9D, 0x1C, 0x25, 0x96, 0xD0, 0xD7, 0xDC, 0xB7, 100);
		...
		/// </list>
		/// </remarks>
		public static PropertyKey DestDistanceNumerator => new PropertyKey(0x2BDA47DA, 0x08C6, 0x4FE1, 0x80, 0xBC, 0xA7, 0x2F, 0xC5, 0x17, 0xC5, 0xD0, 100);
		...
		/// </list>
		/// </remarks>
		public static PropertyKey DestDistanceRef => new PropertyKey(0xED4DF2D3, 0x8695, 0x450B, 0x85, 0x6F, 0xF5, 0xC1, 0xC5, 0x3A, 0xCB, 0x66, 100);
		...
		/// </list>
		/// </remarks>
		public static PropertyKey DestLatitude => new PropertyKey(0x9D1D7CC5, 0x5C39, 0x451C, 0x86, 0xB3, 0x92, 0x8E, 0x2D, 0x18, 0xCC, 0x47, 100);
		...
		/// </list>
		/// </remarks>
		public static PropertyKey DestLatitudeDenominator => new PropertyKey(0x3A372292, 0x7FCA, 0x49A7, 0x99, 0xD5, 0xE4, 0x7B, 0xB2, 0xD4, 0xE7, 0xAB, 100);
		...
		/// </list>
		/// </remarks>
		public static PropertyKey DestLatitudeNumerator => new PropertyKey(0xECF4B6F6, 0xD5A6, 0x433C, 0xBB, 0x92, 0x40, 0x76, 0x65, 0x0F, 0xC8, 0x90, 100);
		...
		/// </list>
		/// </remarks>
		public static PropertyKey DestLatitudeRef => new PropertyKey(0xCEA820B9, 0xCE61, 0x4885, 0xA1, 0x28, 0x00, 0x5D, 0x90, 0x87, 0xC1, 0x92, 100);
		...
		/// </list>
		/// </remarks>
		public static PropertyKey DestLongitude => new PropertyKey(0x47A96261, 0xCB4C, 0x4807, 0x8A, 0xD3, 0x40, 0xB9, 0xD9, 0xDB, 0xC6, 0xBC, 100);
		...
		/// </list>
		/// </remarks>
		public static PropertyKey DestLongitudeDenominator => new PropertyKey(0x425D69E5, 0x48AD, 0x4900, 0x8D, 0x80, 0x6E, 0xB6, 0xB8, 0xD0, 0xAC, 0x86, 100);
		...
		/// </list>
		/// </remarks>
		public static PropertyKey DestLongitudeNumerator => new PropertyKey(0xA3250282, 0xFB6D, 0x48D5, 0x9A, 0x89, 0xDB, 0xCA, 0xCE, 0x75, 0xCC, 0xCF, 100);
		...
		/// </list>
		/// </remarks>
		public static PropertyKey DestLongitudeRef => new PropertyKey(0x182C1EA6, 0x7C1C, 0x4083, 0xAB, 0x4B, 0xAC, 0x6C, 0x9F, 0x4E, 0xD1, 0x28, 100);
		...
		/// </list>
		/// </remarks>
		public static PropertyKey Differential => new PropertyKey(0xAAF4EE25, 0xBD3B, 0x4DD7, 0xBF, 0xC4, 0x47, 0xF7, 0x7B, 0xB0, 0x0F, 0x6D, 100);
		...
		/// </list>
		/// </remarks>
		public static PropertyKey DOP => new PropertyKey(0x0CF8FB02, 0x1837, 0x42F1, 0xA6, 0x97, 0xA7, 0x01, 0x7A, 0xA2, 0x89, 0xB9, 100);
		...
		/// </list>
		/// </remarks>
		public static PropertyKey DOPDenominator => new PropertyKey(0xA0BE94C5, 0x50BA, 0x487B, 0xBD, 0x35, 0x06, 0x54, 0xBE, 0x88, 0x81, 0xED, 100);
		...
		/// </list>
		/// </remarks>
		public static PropertyKey DOPNumerator => new PropertyKey(0x47166B16, 0x364F, 0x4AA0, 0x9F, 0x31, 0xE2, 0xAB, 0x3D, 0xF4, 0x49, 0xC3, 100);
		...
		/// </list>
		/// </remarks>
		public static PropertyKey ImgDirection => new PropertyKey(0x16473C91, 0xD017, 0x4ED9, 0xBA, 0x4D, 0xB6, 0xBA, 0xA5, 0x5D, 0xBC, 0xF8, 100);
		...
		/// </list>
		/// </remarks>
		public static PropertyKey ImgDirectionDenominator => new PropertyKey(0x10B24595, 0x41A2, 0x4E20, 0x93, 0xC2, 0x57, 0x61, 0xC1, 0x39, 0x5F, 0x32, 100);
		...
		/// </list>
		/// </remarks>
		public static PropertyKey ImgDirectionNumerator => new PropertyKey(0xDC5877C7, 0x225F, 0x45F7, 0xBA, 0xC7, 0xE8, 0x13, 0x34, 0xB6, 0x13, 0x0A, 100);
		...
		/// </list>
		/// </remarks>
		public static PropertyKey ImgDirectionRef => new PropertyKey(0xA4AAA5B7, 0x1AD0, 0x445F, 0x81, 0x1A, 0x0F, 0x8F, 0x6E, 0x67, 0xF6, 0xB5, 100);
		...
		/// </list>
		/// </remarks>
		public static PropertyKey Latitude => new PropertyKey(0x8727CFFF, 0x4868, 0x4EC6, 0xAD, 0x5B, 0x81, 0xB9, 0x85, 0x21, 0xD1, 0xAB, 100);
		...
		/// </list>
		/// </remarks>
		public static PropertyKey LatitudeDenominator => new PropertyKey(0x16E634EE, 0x2BFF, 0x497B, 0xBD, 0x8A, 0x43, 0x41, 0xAD, 0x39, 0xEE, 0xB9, 100);
		...
		/// </list>
		/// </remarks>
		public static PropertyKey LatitudeNumerator => new PropertyKey(0x7DDAAAD1, 0xCCC8, 0x41AE, 0xB7, 0x50, 0xB2, 0xCB, 0x80, 0x31, 0xAE, 0xA2, 100);
		...
		/// </list>
		/// </remarks>
		public static PropertyKey LatitudeRef => new PropertyKey(0x029C0252, 0x5B86, 0x46C7, 0xAC, 0xA0, 0x27, 0x69, 0xFF, 0xC8, 0xE3, 0xD4, 100);
		...
		/// </list>
		/// </remarks>
		public static PropertyKey Longitude => new PropertyKey(0xC4C4DBB2, 0xB593, 0x466B, 0xBB, 0xDA, 0xD0, 0x3D, 0x27, 0xD5, 0xE4, 0x3A, 100);
		...
		/// </list>
		/// </remarks>
		public static PropertyKey LongitudeDenominator => new PropertyKey(0xBE6E176C, 0x4534, 0x4D2C, 0xAC, 0xE5, 0x31, 0xDE, 0xDA, 0xC1, 0x60, 0x6B, 100);
		...
		/// </list>
		/// </remarks>
		public static PropertyKey LongitudeNumerator => new PropertyKey(0x02B0F689, 0xA914, 0x4E45, 0x82, 0x1D, 0x1D, 0xDA, 0x45, 0x2E, 0xD2, 0xC4, 100);
		...
		/// </list>
		/// </remarks>
		public static PropertyKey LongitudeRef => new PropertyKey(0x33DCF22B, 0x28D5, 0x464C, 0x80, 0x35, 0x1E, 0xE9, 0xEF, 0xD2, 0x52, 0x78, 100);
		...
		/// </list>
		/// </remarks>
		public static PropertyKey MapDatum => new PropertyKey(0x2CA2DAE6, 0xEDDC, 0x407D, 0xBE, 0xF1, 0x77, 0x39, 0x42, 0xAB, 0xFA, 0x95, 100);
		...
		/// </list>
		/// </remarks>
		public static PropertyKey MeasureMode => new PropertyKey(0xA015ED5D, 0xAAEA, 0x4D58, 0x8A, 0x86, 0x3C, 0x58, 0x69, 0x20, 0xEA, 0x0B, 100);
		...
		/// </list>
		/// </remarks>
		public static PropertyKey ProcessingMethod => new PropertyKey(0x59D49E61, 0x840F, 0x4AA9, 0xA9, 0x39, 0xE2, 0x09, 0x9B, 0x7F, 0x63, 0x99, 100);
		...
		/// </list>
		/// </remarks>
		public static PropertyKey Satellites => new PropertyKey(0x467EE575, 0x1F25, 0x4557, 0xAD, 0x4E, 0xB8, 0xB5, 0x8B, 0x0D, 0x9C, 0x15, 100);
		...
		/// </list>
		/// </remarks>
		public static PropertyKey Speed => new PropertyKey(0xDA5D0862, 0x6E76, 0x4E1B, 0xBA, 0xBD, 0x70, 0x02, 0x1B, 0xD2, 0x54, 0x94, 100);
		...
		/// </list>
		/// </remarks>
		public static PropertyKey SpeedDenominator => new PropertyKey(0x7D122D5A, 0xAE5E, 0x4335, 0x88, 0x41, 0xD7, 0x1E, 0x7C, 0xE7, 0x2F, 0x53, 100);
		...
		/// </list>
		/// </remarks>
		public static PropertyKey SpeedNumerator => new PropertyKey(0xACC9CE3D, 0xC213, 0x4942, 0x8B, 0x48, 0x6D, 0x08, 0x20, 0xF2, 0x1C, 0x6D, 100);
		...
		/// </list>
		/// </remarks>
		public static PropertyKey SpeedRef => new PropertyKey(0xECF7F4C9, 0x544F, 0x4D6D, 0x9D, 0x98, 0x8A, 0xD7, 0x9A, 0xDA, 0xF4, 0x53, 100);
		...
		/// </list>
		/// </remarks>
		public static PropertyKey Status => new PropertyKey(0x125491F4, 0x818F, 0x46B2, 0x91, 0xB5, 0xD5, 0x37, 0x75, 0x36, 0x17, 0xB2, 100);
		...
		/// </list>
		/// </remarks>
		public static PropertyKey Track => new PropertyKey(0x76C09943, 0x7C33, 0x49E3, 0x9E, 0x7E, 0xCD, 0xBA, 0x87, 0x2C, 0xFA, 0xDA, 100);
		...
		/// </list>
		/// </remarks>
		public static PropertyKey TrackDenominator => new PropertyKey(0xC8D1920C, 0x01F6, 0x40C0, 0xAC, 0x86, 0x2F, 0x3A, 0x4A, 0xD0, 0x07, 0x70, 100);
		...
		/// </list>
		/// </remarks>
		public static PropertyKey TrackNumerator => new PropertyKey(0x702926F4, 0x44A6, 0x43E1, 0xAE, 0x71, 0x45, 0x62, 0x71, 0x16, 0x89, 0x3B, 100);
		...
		/// </list>
		/// </remarks>
		public static PropertyKey TrackRef => new PropertyKey(0x35DBE6FE, 0x44C3, 0x4400, 0xAA, 0xAE, 0xD2, 0xC7, 0x99, 0xC4, 0x07, 0xE8, 100);
		...
		/// </list>
		/// </remarks>
		public static PropertyKey VersionID => new PropertyKey(0x22704DA4, 0xC6B2, 0x4A99, 0x8E, 0x56, 0xF1, 0x6D, 0xF8, 0xC9, 0x25, 0x99, 100);
	}
}
