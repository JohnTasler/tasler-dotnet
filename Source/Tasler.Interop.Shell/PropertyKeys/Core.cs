...
namespace Tasler.Interop.Shell
{
	public static partial class PropertyKeys
	{
		public static class Core
		{
			...
			/// </list>
			/// </remarks>
			public static PropertyKey AcquisitionID { get { return new PropertyKey(0x65A98875, 0x3C80, 0x40AB, 0xAB, 0xBC, 0xEF, 0xDA, 0xF7, 0x7D, 0xBE, 0xE2, 100); } }
			...
			/// </list>
			/// </remarks>
			public static PropertyKey ApplicationName { get { return new PropertyKey(0xF29F85E0, 0x4FF9, 0x1068, 0xAB, 0x91, 0x08, 0x00, 0x2B, 0x27, 0xB3, 0xD9, 18); } }
			...
			/// </list>
			/// </remarks>
			public static PropertyKey Author { get { return new PropertyKey(0xF29F85E0, 0x4FF9, 0x1068, 0xAB, 0x91, 0x08, 0x00, 0x2B, 0x27, 0xB3, 0xD9, 4); } }
			...
			/// </list>
			/// </remarks>
			public static PropertyKey Capacity { get { return new PropertyKey(0x9B174B35, 0x40FF, 0x11D2, 0xA2, 0x7E, 0x00, 0xC0, 0x4F, 0xC3, 0x08, 0x71, 3); } }
			...
			/// </list>
			/// </remarks>
			public static PropertyKey Category { get { return new PropertyKey(0xD5CDD502, 0x2E9C, 0x101B, 0x93, 0x97, 0x08, 0x00, 0x2B, 0x2C, 0xF9, 0xAE, 2); } }
			...
			/// </list>
			/// </remarks>
			public static PropertyKey Comment { get { return new PropertyKey(0xF29F85E0, 0x4FF9, 0x1068, 0xAB, 0x91, 0x08, 0x00, 0x2B, 0x27, 0xB3, 0xD9, 6); } }
			...
			/// </list>
			/// </remarks>
			public static PropertyKey Company { get { return new PropertyKey(0xD5CDD502, 0x2E9C, 0x101B, 0x93, 0x97, 0x08, 0x00, 0x2B, 0x2C, 0xF9, 0xAE, 15); } }
			...
			/// </list>
			/// </remarks>
			public static PropertyKey ComputerName { get { return new PropertyKey(0x28636AA6, 0x953D, 0x11D2, 0xB5, 0xD6, 0x00, 0xC0, 0x4F, 0xD9, 0x18, 0xD0, 5); } }
			...
			/// </list>
			/// </remarks>
			public static PropertyKey ContainedItems { get { return new PropertyKey(0x28636AA6, 0x953D, 0x11D2, 0xB5, 0xD6, 0x00, 0xC0, 0x4F, 0xD9, 0x18, 0xD0, 29); } }
			...
			/// </list>
			/// </remarks>
			public static PropertyKey ContentStatus { get { return new PropertyKey(0xD5CDD502, 0x2E9C, 0x101B, 0x93, 0x97, 0x08, 0x00, 0x2B, 0x2C, 0xF9, 0xAE, 27); } }
			...
			/// </list>
			/// </remarks>
			public static PropertyKey ContentType { get { return new PropertyKey(0xD5CDD502, 0x2E9C, 0x101B, 0x93, 0x97, 0x08, 0x00, 0x2B, 0x2C, 0xF9, 0xAE, 26); } }
			...
			/// </list>
			/// </remarks>
			public static PropertyKey Copyright { get { return new PropertyKey(0x64440492, 0x4C8B, 0x11D1, 0x8B, 0x70, 0x08, 0x00, 0x36, 0xB1, 0x1A, 0x03, 11); } }
			...
			/// </list>
			/// </remarks>
			public static PropertyKey DateAccessed { get { return new PropertyKey(0xB725F130, 0x47EF, 0x101A, 0xA5, 0xF1, 0x02, 0x60, 0x8C, 0x9E, 0xEB, 0xAC, 16); } }
			...
			/// </list>
			/// </remarks>
			public static PropertyKey DateAcquired { get { return new PropertyKey(0x2CBAA8F5, 0xD81F, 0x47CA, 0xB1, 0x7A, 0xF8, 0xD8, 0x22, 0x30, 0x01, 0x31, 100); } }
			...
			/// </list>
			/// </remarks>
			public static PropertyKey DateArchived { get { return new PropertyKey(0x43F8D7B7, 0xA444, 0x4F87, 0x93, 0x83, 0x52, 0x27, 0x1C, 0x9B, 0x91, 0x5C, 100); } }
			...
			/// </list>
			/// </remarks>
			public static PropertyKey DateCompleted { get { return new PropertyKey(0x72FAB781, 0xACDA, 0x43E5, 0xB1, 0x55, 0xB2, 0x43, 0x4F, 0x85, 0xE6, 0x78, 100); } }
			...
			/// </list>
			/// </remarks>
			public static PropertyKey DateCreated { get { return new PropertyKey(0xB725F130, 0x47EF, 0x101A, 0xA5, 0xF1, 0x02, 0x60, 0x8C, 0x9E, 0xEB, 0xAC, 15); } }
			...
			/// </list>
			/// </remarks>
			public static PropertyKey DateImported { get { return new PropertyKey(0x14B81DA1, 0x0135, 0x4D31, 0x96, 0xD9, 0x6C, 0xBF, 0xC9, 0x67, 0x1A, 0x99, 18258); } }
			...
			/// </list>
			/// </remarks>
			public static PropertyKey DateModified { get { return new PropertyKey(0xB725F130, 0x47EF, 0x101A, 0xA5, 0xF1, 0x02, 0x60, 0x8C, 0x9E, 0xEB, 0xAC, 14); } }
			...
			/// </list>
			/// </remarks>
			public static PropertyKey DueDate { get { return new PropertyKey(0x3F8472B5, 0xE0AF, 0x4DB2, 0x80, 0x71, 0xC5, 0x3F, 0xE7, 0x6A, 0xE7, 0xCE, 100); } }
			...
			/// </list>
			/// </remarks>
			public static PropertyKey EndDate { get { return new PropertyKey(0xC75FAA05, 0x96FD, 0x49E7, 0x9C, 0xB4, 0x9F, 0x60, 0x10, 0x82, 0xD5, 0x53, 100); } }
			...
			/// </list>
			/// </remarks>
			public static PropertyKey FileAllocationSize { get { return new PropertyKey(0xB725F130, 0x47EF, 0x101A, 0xA5, 0xF1, 0x02, 0x60, 0x8C, 0x9E, 0xEB, 0xAC, 18); } }
			...
			/// </list>
			/// </remarks>
			public static PropertyKey FileAttributes { get { return new PropertyKey(0xB725F130, 0x47EF, 0x101A, 0xA5, 0xF1, 0x02, 0x60, 0x8C, 0x9E, 0xEB, 0xAC, 13); } }
			...
			/// </list>
			/// </remarks>
			public static PropertyKey FileCount { get { return new PropertyKey(0x28636AA6, 0x953D, 0x11D2, 0xB5, 0xD6, 0x00, 0xC0, 0x4F, 0xD9, 0x18, 0xD0, 12); } }
			...
			/// </list>
			/// </remarks>
			public static PropertyKey FileDescription { get { return new PropertyKey(0x0CEF7D53, 0xFA64, 0x11D1, 0xA2, 0x03, 0x00, 0x00, 0xF8, 0x1F, 0xED, 0xEE, 3); } }
			...
			/// </list>
			/// </example>
			public static PropertyKey FileExtension { get { return new PropertyKey(0xE4F10A3C, 0x49E6, 0x405D, 0x82, 0x88, 0xA2, 0x3B, 0xD4, 0xEE, 0xAA, 0x6C, 100); } }
			...
			/// </list>
			/// </remarks>
			public static PropertyKey FileFRN { get { return new PropertyKey(0xB725F130, 0x47EF, 0x101A, 0xA5, 0xF1, 0x02, 0x60, 0x8C, 0x9E, 0xEB, 0xAC, 21); } }
			...
			/// </list>
			/// </example>
			public static PropertyKey FileName { get { return new PropertyKey(0x41CF5AE0, 0xF75A, 0x4806, 0xBD, 0x87, 0x59, 0xC7, 0xD9, 0x24, 0x8E, 0xB9, 100); } }
			...
			/// </list>
			/// </remarks>
			public static PropertyKey FileOwner { get { return new PropertyKey(0x9B174B34, 0x40FF, 0x11D2, 0xA2, 0x7E, 0x00, 0xC0, 0x4F, 0xC3, 0x08, 0x71, 4); } }
			...
			/// </list>
			/// </remarks>
			public static PropertyKey FileVersion { get { return new PropertyKey(0x0CEF7D53, 0xFA64, 0x11D1, 0xA2, 0x03, 0x00, 0x00, 0xF8, 0x1F, 0xED, 0xEE, 4); } }
			...
			/// </list>
			/// </remarks>
			public static PropertyKey FindData { get { return new PropertyKey(0x28636AA6, 0x953D, 0x11D2, 0xB5, 0xD6, 0x00, 0xC0, 0x4F, 0xD9, 0x18, 0xD0, 0); } }
			...
			/// </list>
			/// </remarks>
			public static PropertyKey FlagColor { get { return new PropertyKey(0x67DF94DE, 0x0CA7, 0x4D6F, 0xB7, 0x92, 0x05, 0x3A, 0x3E, 0x4F, 0x03, 0xCF, 100); } }
			...
			/// </list>
			/// </remarks>
			public static PropertyKey FlagColorText { get { return new PropertyKey(0x45EAE747, 0x8E2A, 0x40AE, 0x8C, 0xBF, 0xCA, 0x52, 0xAB, 0xA6, 0x15, 0x2A, 100); } }
			...
			/// </list>
			/// </remarks>
			public static PropertyKey FlagStatus { get { return new PropertyKey(0xE3E0584C, 0xB788, 0x4A5A, 0xBB, 0x20, 0x7F, 0x5A, 0x44, 0xC9, 0xAC, 0xDD, 12); } }
			...
			/// </list>
			/// </remarks>
			public static PropertyKey FlagStatusText { get { return new PropertyKey(0xDC54FD2E, 0x189D, 0x4871, 0xAA, 0x01, 0x08, 0xC2, 0xF5, 0x7A, 0x4A, 0xBC, 100); } }
			...
			/// </list>
			/// </remarks>
			public static PropertyKey FreeSpace { get { return new PropertyKey(0x9B174B35, 0x40FF, 0x11D2, 0xA2, 0x7E, 0x00, 0xC0, 0x4F, 0xC3, 0x08, 0x71, 2); } }
			...
			/// </list>
			/// </remarks>
			public static PropertyKey Identity { get { return new PropertyKey(0xA26F4AFC, 0x7346, 0x4299, 0xBE, 0x47, 0xEB, 0x1A, 0xE6, 0x13, 0x13, 0x9F, 100); } }
			...
			/// </list>
			/// </remarks>
			public static PropertyKey Importance { get { return new PropertyKey(0xE3E0584C, 0xB788, 0x4A5A, 0xBB, 0x20, 0x7F, 0x5A, 0x44, 0xC9, 0xAC, 0xDD, 11); } }
			...
			/// </list>
			/// </remarks>
			public static PropertyKey ImportanceText { get { return new PropertyKey(0xA3B29791, 0x7713, 0x4E1D, 0xBB, 0x40, 0x17, 0xDB, 0x85, 0xF0, 0x18, 0x31, 100); } }
			...
			/// </list>
			/// </remarks>
			public static PropertyKey IsAttachment { get { return new PropertyKey(0xF23F425C, 0x71A1, 0x4FA8, 0x92, 0x2F, 0x67, 0x8E, 0xA4, 0xA6, 0x04, 0x08, 100); } }
			...
			/// </list>
			/// </remarks>
			public static PropertyKey IsDeleted { get { return new PropertyKey(0x5CDA5FC8, 0x33EE, 0x4FF3, 0x90, 0x94, 0xAE, 0x7B, 0xD8, 0x86, 0x8C, 0x4D, 100); } }
			...
			/// </list>
			/// </remarks>
			public static PropertyKey IsFlagged { get { return new PropertyKey(0x5DA84765, 0xE3FF, 0x4278, 0x86, 0xB0, 0xA2, 0x79, 0x67, 0xFB, 0xDD, 0x03, 100); } }
			...
			/// </list>
			/// </remarks>
			public static PropertyKey IsFlaggedComplete { get { return new PropertyKey(0xA6F360D2, 0x55F9, 0x48DE, 0xB9, 0x09, 0x62, 0x0E, 0x09, 0x0A, 0x64, 0x7C, 100); } }
			...
			/// </list>
			/// </remarks>
			public static PropertyKey IsIncomplete { get { return new PropertyKey(0x346C8BD1, 0x2E6A, 0x4C45, 0x89, 0xA4, 0x61, 0xB7, 0x8E, 0x8E, 0x70, 0x0F, 100); } }
			...
			/// </list>
			/// </remarks>
			public static PropertyKey IsRead { get { return new PropertyKey(0xE3E0584C, 0xB788, 0x4A5A, 0xBB, 0x20, 0x7F, 0x5A, 0x44, 0xC9, 0xAC, 0xDD, 10); } }
			...
			/// </list>
			/// </remarks>
			public static PropertyKey IsSendToTarget { get { return new PropertyKey(0x28636AA6, 0x953D, 0x11D2, 0xB5, 0xD6, 0x00, 0xC0, 0x4F, 0xD9, 0x18, 0xD0, 33); } }
			...
			/// </list>
			/// </remarks>
			public static PropertyKey IsShared { get { return new PropertyKey(0xEF884C5B, 0x2BFE, 0x41BB, 0xAA, 0xE5, 0x76, 0xEE, 0xDF, 0x4F, 0x99, 0x02, 100); } }
			...
			/// </list>
			/// </remarks>
			public static PropertyKey ItemAuthors { get { return new PropertyKey(0xD0A04F0A, 0x462A, 0x48A4, 0xBB, 0x2F, 0x37, 0x06, 0xE8, 0x8D, 0xBD, 0x7D, 100); } }
			...
			/// </list>
			/// </remarks>
			public static PropertyKey ItemDate { get { return new PropertyKey(0xF7DB74B4, 0x4287, 0x4103, 0xAF, 0xBA, 0xF1, 0xB1, 0x3D, 0xCD, 0x75, 0xCF, 100); } }
			...
			/// </list>
			/// </example>
			public static PropertyKey ItemFolderNameDisplay { get { return new PropertyKey(0xB725F130, 0x47EF, 0x101A, 0xA5, 0xF1, 0x02, 0x60, 0x8C, 0x9E, 0xEB, 0xAC, 2); } }
			...
			/// </list>
			/// </example>
			public static PropertyKey ItemFolderPathDisplay { get { return new PropertyKey(0xE3E0584C, 0xB788, 0x4A5A, 0xBB, 0x20, 0x7F, 0x5A, 0x44, 0xC9, 0xAC, 0xDD, 6); } }
			...
			/// </list>
			/// </example>
			public static PropertyKey ItemFolderPathDisplayNarrow { get { return new PropertyKey(0xDABD30ED, 0x0043, 0x4789, 0xA7, 0xF8, 0xD0, 0x13, 0xA4, 0x73, 0x66, 0x22, 100); } }
			...
			/// </remarks>
			public static PropertyKey ItemName { get { return new PropertyKey(0x6B8DA074, 0x3B5C, 0x43BC, 0x88, 0x6F, 0x0A, 0x2C, 0xDC, 0xE0, 0x0B, 0x6F, 100); } }
			...
			/// </list>
			/// </example>
			public static PropertyKey ItemNameDisplay { get { return new PropertyKey(0xB725F130, 0x47EF, 0x101A, 0xA5, 0xF1, 0x02, 0x60, 0x8C, 0x9E, 0xEB, 0xAC, 10); } }
			...
			/// </list>
			/// </example>
			public static PropertyKey ItemNamePrefix { get { return new PropertyKey(0xD7313FF1, 0xA77A, 0x401C, 0x8C, 0x99, 0x3D, 0xBD, 0xD6, 0x8A, 0xDD, 0x36, 100); } }
			...
			/// </list>
			/// </remarks>
			public static PropertyKey ItemParticipants { get { return new PropertyKey(0xD4D0AA16, 0x9948, 0x41A4, 0xAA, 0x85, 0xD9, 0x7F, 0xF9, 0x64, 0x69, 0x93, 100); } }
			...
			/// </list>
			/// </example>
			public static PropertyKey ItemPathDisplay { get { return new PropertyKey(0xE3E0584C, 0xB788, 0x4A5A, 0xBB, 0x20, 0x7F, 0x5A, 0x44, 0xC9, 0xAC, 0xDD, 7); } }
			...
			/// </list>
			/// </example>
			public static PropertyKey ItemPathDisplayNarrow { get { return new PropertyKey(0x28636AA6, 0x953D, 0x11D2, 0xB5, 0xD6, 0x00, 0xC0, 0x4F, 0xD9, 0x18, 0xD0, 8); } }
			...
			/// </list>
			/// </example>
			public static PropertyKey ItemType { get { return new PropertyKey(0x28636AA6, 0x953D, 0x11D2, 0xB5, 0xD6, 0x00, 0xC0, 0x4F, 0xD9, 0x18, 0xD0, 11); } }
			...
			/// </list>
			/// </example>
			public static PropertyKey ItemTypeText { get { return new PropertyKey(0xB725F130, 0x47EF, 0x101A, 0xA5, 0xF1, 0x02, 0x60, 0x8C, 0x9E, 0xEB, 0xAC, 4); } }
			...
			/// </list>
			/// </example>
			public static PropertyKey ItemUrl { get { return new PropertyKey(0x49691C90, 0x7E17, 0x101A, 0xA9, 0x1C, 0x08, 0x00, 0x2B, 0x2E, 0xCD, 0xA9, 9); } }
			...
			/// </list>
			/// </remarks>
			public static PropertyKey Keywords { get { return new PropertyKey(0xF29F85E0, 0x4FF9, 0x1068, 0xAB, 0x91, 0x08, 0x00, 0x2B, 0x27, 0xB3, 0xD9, 5); } }
			...
			/// </remarks>
			public static PropertyKey Kind { get { return new PropertyKey(0x1E3EE840, 0xBC2B, 0x476C, 0x82, 0x37, 0x2A, 0xCD, 0x1A, 0x83, 0x9B, 0x22, 3); } }
			...
			/// </list>
			/// </remarks>
			public static PropertyKey KindText { get { return new PropertyKey(0xF04BEF95, 0xC585, 0x4197, 0xA2, 0xB7, 0xDF, 0x46, 0xFD, 0xC9, 0xEE, 0x6D, 100); } }
			...
			/// </list>
			/// </remarks>
			public static PropertyKey Language { get { return new PropertyKey(0xD5CDD502, 0x2E9C, 0x101B, 0x93, 0x97, 0x08, 0x00, 0x2B, 0x2C, 0xF9, 0xAE, 28); } }
			...
			/// </list>
			/// </remarks>
			public static PropertyKey MileageInformation { get { return new PropertyKey(0xFDF84370, 0x031A, 0x4ADD, 0x9E, 0x91, 0x0D, 0x77, 0x5F, 0x1C, 0x66, 0x05, 100); } }
			...
			/// </list>
			/// </remarks>
			public static PropertyKey MIMEType { get { return new PropertyKey(0x0B63E350, 0x9CCC, 0x11D0, 0xBC, 0xDB, 0x00, 0x80, 0x5F, 0xCC, 0xCE, 0x04, 5); } }
			...
			/// </list>
			/// </remarks>
			public static PropertyKey Null { get { return new PropertyKey(0x00000000, 0x0000, 0x0000, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0); } }
			...
			/// </list>
			/// </remarks>
			public static PropertyKey OfflineAvailability { get { return new PropertyKey(0xA94688B6, 0x7D9F, 0x4570, 0xA6, 0x48, 0xE3, 0xDF, 0xC0, 0xAB, 0x2B, 0x3F, 100); } }
			...
			/// </list>
			/// </remarks>
			public static PropertyKey OfflineStatus { get { return new PropertyKey(0x6D24888F, 0x4718, 0x4BDA, 0xAF, 0xED, 0xEA, 0x0F, 0xB4, 0x38, 0x6C, 0xD8, 100); } }
			...
			/// </list>
			/// </remarks>
			public static PropertyKey OriginalFileName { get { return new PropertyKey(0x0CEF7D53, 0xFA64, 0x11D1, 0xA2, 0x03, 0x00, 0x00, 0xF8, 0x1F, 0xED, 0xEE, 6); } }
			...
			/// </list>
			/// </remarks>
			public static PropertyKey ParentalRating { get { return new PropertyKey(0x64440492, 0x4C8B, 0x11D1, 0x8B, 0x70, 0x08, 0x00, 0x36, 0xB1, 0x1A, 0x03, 21); } }
			...
			/// </list>
			/// </remarks>
			public static PropertyKey ParentalRatingReason { get { return new PropertyKey(0x10984E0A, 0xF9F2, 0x4321, 0xB7, 0xEF, 0xBA, 0xF1, 0x95, 0xAF, 0x43, 0x19, 100); } }
			...
			/// </list>
			/// </remarks>
			public static PropertyKey ParentalRatingsOrganization { get { return new PropertyKey(0xA7FE0840, 0x1344, 0x46F0, 0x8D, 0x37, 0x52, 0xED, 0x71, 0x2A, 0x4B, 0xF9, 100); } }
			...
			/// </list>
			/// </remarks>
			public static PropertyKey ParsingBindContext { get { return new PropertyKey(0xDFB9A04D, 0x362F, 0x4CA3, 0xB3, 0x0B, 0x02, 0x54, 0xB1, 0x7B, 0x5B, 0x84, 100); } }
			...
			/// </list>
			/// </remarks>
			public static PropertyKey ParsingName { get { return new PropertyKey(0x28636AA6, 0x953D, 0x11D2, 0xB5, 0xD6, 0x00, 0xC0, 0x4F, 0xD9, 0x18, 0xD0, 24); } }
			...
			/// </remarks>
			public static PropertyKey ParsingPath { get { return new PropertyKey(0x28636AA6, 0x953D, 0x11D2, 0xB5, 0xD6, 0x00, 0xC0, 0x4F, 0xD9, 0x18, 0xD0, 30); } }
			...
			/// </remarks>
			public static PropertyKey PerceivedType { get { return new PropertyKey(0x28636AA6, 0x953D, 0x11D2, 0xB5, 0xD6, 0x00, 0xC0, 0x4F, 0xD9, 0x18, 0xD0, 9); } }
			...
			/// </list>
			/// </remarks>
			public static PropertyKey PercentFull { get { return new PropertyKey(0x9B174B35, 0x40FF, 0x11D2, 0xA2, 0x7E, 0x00, 0xC0, 0x4F, 0xC3, 0x08, 0x71, 5); } }
			...
			/// </list>
			/// </remarks>
			public static PropertyKey Priority { get { return new PropertyKey(0x9C1FCF74, 0x2D97, 0x41BA, 0xB4, 0xAE, 0xCB, 0x2E, 0x36, 0x61, 0xA6, 0xE4, 5); } }
			...
			/// </list>
			/// </remarks>
			public static PropertyKey PriorityText { get { return new PropertyKey(0xD98BE98B, 0xB86B, 0x4095, 0xBF, 0x52, 0x9D, 0x23, 0xB2, 0xE0, 0xA7, 0x52, 100); } }
			...
			/// </list>
			/// </remarks>
			public static PropertyKey Project { get { return new PropertyKey(0x39A7F922, 0x477C, 0x48DE, 0x8B, 0xC8, 0xB2, 0x84, 0x41, 0xE3, 0x42, 0xE3, 100); } }
			...
			/// </list>
			/// </remarks>
			public static PropertyKey ProviderItemID { get { return new PropertyKey(0xF21D9941, 0x81F0, 0x471A, 0xAD, 0xEE, 0x4E, 0x74, 0xB4, 0x92, 0x17, 0xED, 100); } }
			...
			/// </list>
			/// </remarks>
			public static PropertyKey Rating { get { return new PropertyKey(0x64440492, 0x4C8B, 0x11D1, 0x8B, 0x70, 0x08, 0x00, 0x36, 0xB1, 0x1A, 0x03, 9); } }
			...
			/// </list>
			/// </remarks>
			public static PropertyKey RatingText { get { return new PropertyKey(0x90197CA7, 0xFD8F, 0x4E8C, 0x9D, 0xA3, 0xB5, 0x7E, 0x1E, 0x60, 0x92, 0x95, 100); } }
			...
			/// </list>
			/// </remarks>
			public static PropertyKey Sensitivity { get { return new PropertyKey(0xF8D3F6AC, 0x4874, 0x42CB, 0xBE, 0x59, 0xAB, 0x45, 0x4B, 0x30, 0x71, 0x6A, 100); } }
			...
			/// </list>
			/// </remarks>
			public static PropertyKey SensitivityText { get { return new PropertyKey(0xD0C7F054, 0x3F72, 0x4725, 0x85, 0x27, 0x12, 0x9A, 0x57, 0x7C, 0xB2, 0x69, 100); } }
			...
			/// </list>
			/// </remarks>
			public static PropertyKey SFGAOFlags { get { return new PropertyKey(0x28636AA6, 0x953D, 0x11D2, 0xB5, 0xD6, 0x00, 0xC0, 0x4F, 0xD9, 0x18, 0xD0, 25); } }
			...
			/// </list>
			/// </remarks>
			public static PropertyKey SharedWith { get { return new PropertyKey(0xEF884C5B, 0x2BFE, 0x41BB, 0xAA, 0xE5, 0x76, 0xEE, 0xDF, 0x4F, 0x99, 0x02, 200); } }
			...
			/// </list>
			/// </remarks>
			public static PropertyKey ShareUserRating { get { return new PropertyKey(0x64440492, 0x4C8B, 0x11D1, 0x8B, 0x70, 0x08, 0x00, 0x36, 0xB1, 0x1A, 0x03, 12); } }
			...
			/// </list>
			/// </remarks>
			public static PropertyKey OmitFromView { get { return new PropertyKey(0xDE35258C, 0xC695, 0x4CBC, 0xB9, 0x82, 0x38, 0xB0, 0xAD, 0x24, 0xCE, 0xD0, 2); } }
			...
			/// </list>
			/// </remarks>
			public static PropertyKey SimpleRating { get { return new PropertyKey(0xA09F084E, 0xAD41, 0x489F, 0x80, 0x76, 0xAA, 0x5B, 0xE3, 0x08, 0x2B, 0xCA, 100); } }
			...
			/// </list>
			/// </remarks>
			public static PropertyKey Size { get { return new PropertyKey(0xB725F130, 0x47EF, 0x101A, 0xA5, 0xF1, 0x02, 0x60, 0x8C, 0x9E, 0xEB, 0xAC, 12); } }
			...
			/// </list>
			/// </remarks>
			public static PropertyKey SoftwareUsed { get { return new PropertyKey(0x14B81DA1, 0x0135, 0x4D31, 0x96, 0xD9, 0x6C, 0xBF, 0xC9, 0x67, 0x1A, 0x99, 305); } }
			...
			/// </list>
			/// </remarks>
			public static PropertyKey SourceItem { get { return new PropertyKey(0x668CDFA5, 0x7A1B, 0x4323, 0xAE, 0x4B, 0xE5, 0x27, 0x39, 0x3A, 0x1D, 0x81, 100); } }
			...
			/// </list>
			/// </remarks>
			public static PropertyKey StartDate { get { return new PropertyKey(0x48FD6EC8, 0x8A12, 0x4CDF, 0xA0, 0x3E, 0x4E, 0xC5, 0xA5, 0x11, 0xED, 0xDE, 100); } }
			...
			/// </list>
			/// </remarks>
			public static PropertyKey Status { get { return new PropertyKey(0x000214A1, 0x0000, 0x0000, 0xC0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x46, 9); } }
			...
			/// </list>
			/// </remarks>
			public static PropertyKey Subject { get { return new PropertyKey(0xF29F85E0, 0x4FF9, 0x1068, 0xAB, 0x91, 0x08, 0x00, 0x2B, 0x27, 0xB3, 0xD9, 3); } }
			...
			/// </list>
			/// </remarks>
			public static PropertyKey Thumbnail { get { return new PropertyKey(0xF29F85E0, 0x4FF9, 0x1068, 0xAB, 0x91, 0x08, 0x00, 0x2B, 0x27, 0xB3, 0xD9, 17); } }
			...
			/// </list>
			/// </remarks>
			public static PropertyKey ThumbnailCacheId { get { return new PropertyKey(0x446D16B1, 0x8DAD, 0x4870, 0xA7, 0x48, 0x40, 0x2E, 0xA4, 0x3D, 0x78, 0x8C, 100); } }
			...
			/// </list>
			/// </remarks>
			public static PropertyKey ThumbnailStream { get { return new PropertyKey(0xF29F85E0, 0x4FF9, 0x1068, 0xAB, 0x91, 0x08, 0x00, 0x2B, 0x27, 0xB3, 0xD9, 27); } }
			...
			/// </list>
			/// </remarks>
			public static PropertyKey Title { get { return new PropertyKey(0xF29F85E0, 0x4FF9, 0x1068, 0xAB, 0x91, 0x08, 0x00, 0x2B, 0x27, 0xB3, 0xD9, 2); } }
			...
			/// </list>
			/// </remarks>
			public static PropertyKey TotalFileSize { get { return new PropertyKey(0x28636AA6, 0x953D, 0x11D2, 0xB5, 0xD6, 0x00, 0xC0, 0x4F, 0xD9, 0x18, 0xD0, 14); } }
			...
			/// </list>
			/// </remarks>
			public static PropertyKey Trademarks { get { return new PropertyKey(0x0CEF7D53, 0xFA64, 0x11D1, 0xA2, 0x03, 0x00, 0x00, 0xF8, 0x1F, 0xED, 0xEE, 9); } }
		}
	}
}