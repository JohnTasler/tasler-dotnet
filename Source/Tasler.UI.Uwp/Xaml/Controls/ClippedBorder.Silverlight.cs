...
public partial class ClippedBorder : Decorator
{
	...
	public ClippedBorder()
	{
		...
		this.SetBorderBinding(Border.BackgroundProperty, nameof(Background));
		this.SetBorderBinding(Border.BorderBrushProperty, nameof(BorderBrush));
		this.SetBorderBinding(Border.BorderThicknessProperty, nameof(BorderThickness));
		this.SetBorderBinding(Border.CornerRadiusProperty, nameof(CornerRadius));
		this.SetBorderBinding(Border.PaddingProperty, nameof(Padding));
	}
	...
	private void SetBorderBinding(DependencyProperty targetProperty, string sourcePropertyName)
	{
