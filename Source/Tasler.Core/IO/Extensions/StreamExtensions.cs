...
public static class StreamExtensions
{
	...
	/// <summary>
	/// Reads a single, fixed-size, unmanaged structure of type <typeparamref name="T"/> from the stream.
	/// </summary>
	...
	/// <exception cref="ArgumentException"><paramref name="this"/> is not readable.</exception>
	...
	/// <summary>
	/// Reads a variable-sized structure from the stream, consisting of a fixed-size header and
	...
	/// </param>
	/// <returns>
	/// A <see cref="VariableSizedStruct{THeader, TElement}"/> instance containing the header and
	/// the array of elements read from the stream.
	/// </returns>
	/// <remarks>
	...
	/// determine how many repeating elements there are. The number of elements is determined by applying
	/// <paramref name="elementCountSelector"/> to the header structure read from the stream.
	/// </remarks>
