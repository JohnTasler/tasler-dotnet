	...
	public class ReaderWriterLockSlimWrapper : IDisposable
	{
		...
		public IDisposable ReadLock
		{
			get
			{
				...
				Debug.WriteLineIf(isLogging, GetCallingFrameInfo("Entering ReadLock"));
		...
		public IDisposable WriteLock
		{
			get
			{
				...
				Debug.WriteLineIf(isLogging, GetCallingFrameInfo("Entering WriteLock"));
		...
		private struct AutoExitRead : IDisposable
		{
			...
			public void Dispose()
			{
				Debug.WriteLineIf(isLogging, ReaderWriterLockSlimWrapper.GetCallingFrameInfo("Exiting ReadLock"));
		...
		private struct AutoExitWrite : IDisposable
		{
			...
			public void Dispose()
			{
				Debug.WriteLineIf(isLogging, ReaderWriterLockSlimWrapper.GetCallingFrameInfo("Exiting WriteLock"));
