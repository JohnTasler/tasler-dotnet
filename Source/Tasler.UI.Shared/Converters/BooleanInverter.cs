...
using ConverterBase = Tasler.Windows.Converters.SingletonValueConverter<Tasler.Windows.Converters.BooleanInverter>;
namespace Tasler.Windows.Converters
#endif
{
	public class BooleanInverter : ConverterBase
	{
		#region Overrides
