...
public static partial class UserApi
{
	internal static partial class NativeMethods
	{
		...
		[LibraryImport(ApiLib, SetLastError = true)]
		public static partial nint LoadIconW(SafeInstanceHandle hInstance, nint pIconName);

		[LibraryImport(ApiLib, SetLastError = true)]
		public static partial nint LoadImageW(
			SafeInstanceHandle hInst, nint name, ImageType type, int cx, int cy, LoadResourceFlags fuLoad);
